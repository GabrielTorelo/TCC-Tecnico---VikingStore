<script>
	function cep()
	{
		...
		if ($cep1 == '' and $cep2 == '')
		{
			echo '	<h1 style="font-weight: bold; color: #303030;">Digite seu CEP</h1><br>
					...
					<input type="submit" value="Pesquisar" style="background-color: #222222; border-radius: 22px; height: 30px; color: #fff; width: 90px; border: 0px; cursor: pointer;"/><br><br>';
		}
				
		elseif ($dados['estado'] == '')
		{
						echo '	<h1 style="font-weight: bold; color: #303030;">Por favor digite um CEP válido!</h1><br>
								<input style="background-color: #222222; border-radius: 22px; height: 30px; color: #fff; width: 90px; border: 0px; cursor: pointer;" type="submit" value="Tentar Novamente"/><br><br>';
		}
		
		else{
				echo '</form>
						<div id="auto">
							<h1 style="font-weight: bold; color: #303030;">Confirme os Dados de sua Residência</h1><br><br>
							<form action="" method="post">
								...
								<input type="submit" name="ddresidencia" value="Confirmar" style="background-color: #222222; border-radius: 22px; height: 30px; color: #fff; width: 90px; border: 0px; cursor: pointer;"/>
							</form>
						</div>';
			}
?>
